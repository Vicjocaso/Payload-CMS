...
export interface Page {
  ...
  title: string;
  /**
   * Optional: apply a template layout when creating this page.
   */
  sourceTemplate?: (number | null) | PageTemplate;
  hero: {
...
/**
 * Reusable page layouts (hero and content blocks). Save from a page or start a new page from a template.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface PageTemplate {
  ...
  category?: ('landing' | 'about' | 'contact' | 'custom') | null;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact';
    richText?: {
      root: {
